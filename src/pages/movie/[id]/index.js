        ...
        <Grid container spacing={4}>
          ...
          <Box sx={{ mt: 4 }}>
            ...
            <Typography variant="body1" sx={{ mb: 1, color: '#003055' }}>
              {movie.duration} • {Array.isArray(movie.genres) ? movie.genres.map(genre => genre.name).join(', ') : 'N/A'}
            </Typography>
            ...
            <Typography variant="body1" sx={{ mb: 1, color: '#003055', fontWeight: 'bold' }}>Writer(s): <Typography component="span" sx={{ fontWeight: 'normal' }}>{movie.writer}</Typography></Typography>
